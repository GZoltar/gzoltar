...
/**
 * GZoltar under Java-11.
 */
public class Java11SystemTest extends SystemTestBase {
    ...
    public void testNumberOfNodes() {
        ...
        assertEquals(9, SPECTRUM.getNumberOfNodes());
    }
    ...
    public void testSetOfNodes() {
        ...
        Set<String> lines = new LinkedHashSet<String>() { {
            add("org.gzoltar.examples$LocalVariableSyntaxTest#LocalVariableSyntaxTest(int,int):27");
            add("org.gzoltar.examples$LocalVariableSyntaxTest#LocalVariableSyntaxTest(int,int):32");
            add("org.gzoltar.examples$LocalVariableSyntaxTest#exec():36");
            add("org.gzoltar.examples$LocalVariableSyntaxTest#lambda$exec$0(int,int):36");
        }
        };
    ...
    public void testNumberOfTransactions() {
        ...
        assertEquals(3, SPECTRUM.getNumberOfTransactions());
    }
    ...
    public void testSetOfTransactions() {
        ...
        Set<String> someTransactionsNames = new LinkedHashSet<String>() { {
            add("org.gzoltar.examples.LocalVariableTest#test1");
            add("org.gzoltar.examples.LocalVariableTest#test2");
            add("org.gzoltar.examples.LocalVariableTest#test3");
        }
        };
    ...
    public void testCoverage() {
        ...
        Transaction a = SPECTRUM.findTransactionByName("org.gzoltar.examples.LocalVariableTest#test1");
        Transaction b = SPECTRUM.findTransactionByName("org.gzoltar.examples.LocalVariableTest#test2");
        Transaction c = SPECTRUM.findTransactionByName("org.gzoltar.examples.LocalVariableTest#test3");
        ...
        Set<String> cHitNodesNames = new LinkedHashSet<String>() { {
            add("org.gzoltar.examples$LocalVariableSyntaxTest#exec():38");
            add("org.gzoltar.examples$LocalVariableSyntaxTest#exec():37");
            add("org.gzoltar.examples$LocalVariableSyntaxTest#exec():36");
        }
        };
    ...
    public void testTestCsvSetOfTests() throws Exception {
        ...
        assertFalse(tests.containsKey("org.gzoltar.examples.LocalVariableTest#test4"));
    }
    ...
    public void testSpectraCsv() throws Exception {
        ...
        Set<String> someLinesNames = new LinkedHashSet<String>() { {
            add("org.gzoltar.examples$LocalVariableSyntaxTest#LocalVariableSyntaxTest(int,int):30");
            add("org.gzoltar.examples$LocalVariableSyntaxTest#LocalVariableSyntaxTest(int,int):31");
            add("org.gzoltar.examples$LocalVariableSyntaxTest#exec():36");
            add("org.gzoltar.examples$LocalVariableSyntaxTest#exec():38");
        }
        };
        ...
        assertFalse(lines.contains("org.gzoltar.examples.LocalVariableTest#test3"));
    }
    ...
    public void testMatrixTxt() throws Exception {
        ...
        assertEquals(9+1, matrix.get(0).size()); // 9 columns (aka lines of code) + 1 test outcome
    ...
    public void testRankingCsv() throws Exception {
        ...
        // 1st
        entry = it.next();
        assertEquals("org.gzoltar.examples$LocalVariableSyntaxTest#LocalVariableSyntaxTest(int,int):29", entry.getKey());
        assertEquals(0.57, entry.getValue(), 0.01);

        // 2nd
        entry = it.next();
        assertEquals("org.gzoltar.examples$LocalVariableSyntaxTest#LocalVariableSyntaxTest(int,int):27", entry.getKey());
        assertEquals(0.57, entry.getValue(), 0.01);

        // 3rd
        entry = it.next();
        assertEquals("org.gzoltar.examples$LocalVariableSyntaxTest#LocalVariableSyntaxTest(int,int):30", entry.getKey());
        assertEquals(0.57, entry.getValue(), 0.01);
    }
