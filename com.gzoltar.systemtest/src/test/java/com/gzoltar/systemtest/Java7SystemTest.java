...
/**
 * GZoltar under Java-7.
 */
public class Java7SystemTest extends SystemTestBase {
  ...
  public void testNumberOfNodes() {
    ...
    assertEquals(20, SPECTRUM.getNumberOfNodes());
  }
  ...
  public void testSetOfNodes() {
    ...
    Set<String> lines = new LinkedHashSet<String>() { {
        ...
        add("org.gzoltar.examples$StaticField#StaticField():22");
  ...
  public void testNumberOfTransactions() {
    ...
    assertEquals(20, SPECTRUM.getNumberOfTransactions());
  }
  ...
  public void testSetOfTransactions() {
    ...
    Set<String> someTransactionsNames = new LinkedHashSet<String>() { {
        add("org.gzoltar.examples.WeekDayParameterizedTests#test[0: shortToLong(MON)=Monday]");
        add("org.gzoltar.examples.WeekDayTest#test10");
        add("org.gzoltar.examples.StaticFieldTest#test1");
      }
    };
  ...
  public void testSetOfFailingTransactions() {
    ...
    Set<String> failingTransactionsNames = new LinkedHashSet<String>() { {
        add("org.gzoltar.examples.WeekDayParameterizedTests#test[3: shortToLong(THU)=Thursday]");
        add("org.gzoltar.examples.WeekDayTest#test4");
        add("org.gzoltar.examples.StaticFieldTest#test3");
      }
    };
  ...
  public void testTestCsvSetOfTests() throws Exception {
    ...
    assertFalse(tests.containsKey("org.gzoltar.examples.StaticFieldTest#test2"));
  }
  ...
  public void testTestCsvSetOfFailingTests() throws Exception {
    ...
    assertEquals(3, numFailingTests);
  ...
  public void testSpectraCsv() throws Exception {
    ...
    assertFalse(lines.contains("org.gzoltar.examples.StaticFieldTest#test2"));
  }
  ...
  public void testMatrixTxt() throws Exception {
    ...
    assertEquals(19, matrix.size());
    assertEquals(20+1, matrix.get(0).size()); // 20 columns (aka lines of code) + 1 test outcome
  ...
  public void testRankingCsv() throws Exception {
    ...
    // 1st
    entry = it.next();
    assertEquals("org.gzoltar.examples$WeekDay#shortToLong(java.lang.String):45", entry.getKey());
    assertEquals(0.81, entry.getValue(), 0.01);

    // 2nd
    entry = it.next();
    assertEquals("org.gzoltar.examples$StaticField#<clinit>():24", entry.getKey());
    assertEquals(0.40, entry.getValue(), 0.01);

    // 3rd
    entry = it.next();
    assertEquals("org.gzoltar.examples$StaticField#<clinit>():27", entry.getKey());
    assertEquals(0.40, entry.getValue(), 0.01);
  }
