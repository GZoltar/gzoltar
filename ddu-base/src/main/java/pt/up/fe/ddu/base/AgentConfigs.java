...
import pt.up.fe.ddu.base.instrumentation.FilterPass;
import pt.up.fe.ddu.base.instrumentation.InstrumentationPass;
import pt.up.fe.ddu.base.instrumentation.Pass;
import pt.up.fe.ddu.base.instrumentation.StackSizePass;
import pt.up.fe.ddu.base.instrumentation.TestFilterPass;
import pt.up.fe.ddu.base.instrumentation.granularity.GranularityFactory.GranularityLevel;
import pt.up.fe.ddu.base.instrumentation.matchers.BlackList;
import pt.up.fe.ddu.base.instrumentation.matchers.DuplicateCollectorReferenceMatcher;
import pt.up.fe.ddu.base.instrumentation.matchers.FieldNameMatcher;
import pt.up.fe.ddu.base.instrumentation.matchers.Matcher;
import pt.up.fe.ddu.base.instrumentation.matchers.ModifierMatcher;
import pt.up.fe.ddu.base.instrumentation.matchers.NotMatcher;
import pt.up.fe.ddu.base.instrumentation.matchers.OrMatcher;
import pt.up.fe.ddu.base.instrumentation.matchers.PrefixMatcher;
import pt.up.fe.ddu.base.instrumentation.matchers.SourceLocationMatcher;
import pt.up.fe.ddu.base.messaging.Client;
...
public class AgentConfigs {
	...
	public static final String BUILD_LOCATION_KEY = "DDUbuildLocationKey";
