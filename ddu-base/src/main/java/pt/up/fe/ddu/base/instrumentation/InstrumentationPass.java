...
import pt.up.fe.ddu.base.instrumentation.granularity.Granularity;
import pt.up.fe.ddu.base.instrumentation.granularity.GranularityFactory;
...
public class InstrumentationPass implements Pass {
	...
	public static final String HIT_VECTOR_NAME = "$__DDU_HIT_VECTOR__";
