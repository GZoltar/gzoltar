...
public abstract class AbstractDDUMojo extends AbstractMojo {
	...
	@Parameter(defaultValue = "${project.build.directory}/ddu-report/")
	...
	protected abstract void executeDDUMojo() throws MojoExecutionException, MojoFailureException;
}
