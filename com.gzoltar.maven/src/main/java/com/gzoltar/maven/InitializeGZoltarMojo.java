...
public class InitializeGZoltarMojo extends AbstractGZoltarMojo {
  ...
  private void setAgent(String agentFilename, AgentConfigs agentConfigs) {
    ...
    sb.append(getProjectProperty(SUREFIRE_ARG_LINE)).append(" -D")
        .append(AgentConfigs.BUILD_LOCATION_KEY).append("='")
        .append(project.getBuild().getDirectory()).append("' ").append(argLine)
        .append(" -javaagent:\"").append(agentFilename).append("\"=")
